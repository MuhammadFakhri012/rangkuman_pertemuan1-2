...
## 🧰 Tools yang Dipakai
- **VS Code** — untuk menulis perintah SQL  
- **Laragon / MySQL** — untuk menjalankan database  
- **Google Colab** — penjelasan materi per pertemuan  
- **GitHub** — penyimpanan dokumentasi
...
## 📌 Catatan
- Materi dibuat sederhana agar mudah dipahami siswa SMK  
- Link materi bisa ditambah setiap pertemuan  
- Gunakan repo ini sebagai panduan belajar
